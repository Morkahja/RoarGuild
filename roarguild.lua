...
local inviteText = {
  ...
  "<ROAR> The land carries us all. Walk it with care, and it will remember you kindly. — Baine’s Elder Seer Ruun, Mulgore (founding of Thunder Bluff)",
  ...
  "<ROAR> I have watched banners burn and crowns turn to dust, yet laughter shared by friends endured longer than any empire. That is the roar worth guarding. — Alaric Dawnsworn, the old wine quarter of Lordaeron, during the quiet decline before the royal courts hardened",
  "<ROAR> When suspicion crept into every conversation, we chose kindness anyway, and it carried us through the years that followed. — Elayne Fairwind, Stormwind canals, in the uneasy rebuilding before the city truly felt safe again",
  "<ROAR> Stone does not rush, and neither should we. The deepest marks are left by those who walk together and return often. — Brottan Stonevein, the lower forges of Ironforge, while clan banners still hung side by side",
  "<ROAR> A hearth kept lit can hold a clan together longer than any fortress wall. I learned that during winters when food was scarce but laughter was not. — Hilda Ambermantle, Dun Morogh foothills, during the long resettlement years",
  "<ROAR> The stars cross the sky without haste, yet they never lose their way. We once shaped our lives by that rhythm. — Thalanor Moonwhisper, Ashenvale glades, during the long vigil before the forests grew crowded",
  "<ROAR> Balance is not silence, but knowing when to stand still and when to speak so another is not alone. — Lyssera Starbloom, Darnassus terraces, in the first calm seasons after the great return to Kalimdor",
  "<ROAR> Curiosity saved us more times than caution ever did. Fear builds walls; questions build exits. — Brizwick Mekkatorn, Gnomeregan design wing, in the months of ignored warnings and overconfidence",
  "<ROAR> An idea locked away is already half broken. Share it, test it, laugh about it, then improve it together. — Tilda Sparkgear, Gnomeregan reclammation facility, during the years of rebuilding with salvaged hands",
  "<ROAR> Strength without restraint is just noise. Strength tempered by respect becomes a roar others will answer. — Kargul Stonefist, Nagrand plains, before the rise of the Old Horde",
  "<ROAR> Hardship forges bonds no victory ever could. Those bonds carried us through chains, camps, and quiet resolve. — Draka Ironwill, the internment stockades, during the internment years",
  "<ROAR> The land carries every footstep we take. Treat it as kin, not resource, and it will carry you farther than pride ever could. — Elder Ruun Earthcaller, the mesas of Mulgore, while the first lifts to Thunder Bluff were tested",
  "<ROAR> Community is not measured in numbers, but in how gently we hold one another upright. — Anaya Plainsong, Thunder Bluff central rise, during the early days of shared tribal council",
  "<ROAR> Despair tempts us to endure alone, but meaning is found when we choose to endure together. — Morlen Ashbound, the inner districts of Lordaeron, as familiar streets emptied",
  "<ROAR> Time may be borrowed, but joy can still be claimed. I chose laughter, even when others called it foolish. — Selindra Blackveil, Undercity upper ring, during the first years of self-rule",
  "<ROAR> A story told around a fire travels farther than any war drum. Share it well, and it will return to you changed. — Zul’kan Firespinner, Durotar work camps, while Orgrimmar was still dust and scaffolds",
  "<ROAR> When the drums quiet and the spirits listen, joy is the offering they accept most readily. — Shadra Spiritcall, Echo Isles, after Zalazane’s fall",
  "<ROAR> Tradition survives not by preservation alone, but by allowing it to breathe in new voices. — Arathiel Sunborne, Silvermoon outer gardens, during the uneasy years of isolation",
  "<ROAR> Exile strips away many things, but grace survives when carried together instead of alone. — Velanna Dawncrest, Theramore docks, during the years of cautious coexistence",
  "<ROAR> Gold vanishes faster than memory. Reputation lingers, whether you plan for it or not. — Rixle Geargrin, Kezan counting halls, late Steamwheedle boom",
  "<ROAR> A shared feast outlasts any contract. Feed people well, and they remember your name. — Vexa Quickcoin, Booty Bay lower decks, during the height of open trade routes"
}
